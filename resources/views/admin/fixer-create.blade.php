        ...
        <form action="{{ route('admin.fixer.store') }}" method="POST">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ old('name') }}" id="exampleInputEmail1"
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" value="{{ old('phone') }}" id="exampleInputEmail1"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ old('address') }}" id="exampleInputEmail1"
